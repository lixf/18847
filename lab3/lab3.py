...
max1 = np.amax(results1, axis=1)
totals1 = np.sum(results1, axis=1)
...
max2 = np.amax(results2, axis=1)
totals2 = np.sum(results2, axis=1)
...
max3 = np.amax(results3, axis=1)
totals3 = np.sum(results3, axis=1)
...
np.savetxt("results2.csv", final_results3, delimiter=",")