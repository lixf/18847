...
def calculate_metrics(data, target):
  # Structure of the TNN
  layer1 = firstlayer.FirstLayer(layer_id=1, training_raw_data=data[0], threshold=8, inhibit_k=3)
  ...
  permutation = np.random.permutation(len(data))[:1000]
...
calculate_metrics(mnist.square_data, mnist.target)
